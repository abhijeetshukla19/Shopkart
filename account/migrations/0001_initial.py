    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_pincode', models.CharField(max_length=6, validators=[django.core.validators.MinLengthValidator(6), django.core.validators.RegexValidator('^\\d{6}$', 'Enter a Valid 6 digit pincode')])),
                ('product_category', models.CharField(choices=[('electronics', 'ELECTRONICS'), ('fashion', 'FASHION'), ('home_appliances', 'HOME APPLIANCES'), ('books', 'BOOKS'), ('beauty', 'BEAUTY'), ('sports', 'SPORTS'), ('toys', 'TOYS'), ('other', 'OTHER')], max_length=25)),
